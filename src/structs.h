...
#define ROOM_NORECALL 18
#define ROOM_NOTELEPORT 19
...
#define ZONE_CONFUSING 7 // Confusing Zone, causing exits to be scrambled.  Salty
...
#define SECT_DESERT 10      // Its a desert, Harry
...
#define CLASS_WIZARD 0       /**< PC Class Magic User */
#define CLASS_PRIEST 1       /**< PC Class Cleric */
...
#define PLR_MULTICLASS 20 /* Salty's Multiclass */
...
#define MOB_HIT_ATTACKERS 20
#define MOB_HIT_ROOM 21
...
#define PRF_DISP_MAXHP 35   // Salty's Prompt Additions
#define PRF_DISP_MAXMANA 36 // 03 JAN 2018
#define PRF_DISP_MAXMOVE 37
#define PRF_DISP_TANK 38
...
#define INFONET_IMM 1
#define INFONET_ALL 2
...
#define AFF_DETECT_ALIGN 3     /**< Char is sensitive to align */  // remove for truesight
#define AFF_DETECT_INVIS 4     /**< Char can see invis chars */  // remove for truesight
#define AFF_DETECT_MAGIC 5     /**< Char is sensitive to magic */  // remove for truesight
#define AFF_SENSE_LIFE 6       /**< Char can sense hidden life */  // remove for truesight
...
#define AFF_PASS_DOOR 18       /**< Pass through unlocked doors */
#define AFF_SNEAK 19           /**< Char can move quietly */
#define AFF_HIDE 20            /**< Char is hidden */
#define AFF_IMP_PASS_DOOR 21   /**< Pass through locked doors */  // remove entirely
#define AFF_CHARM 22           /**< Char is charmed */
#define AFF_FURY 23            // Fury spell
#define AFF_OFFENSE 24         // Offence Fighting Style
#define AFF_DEFENSE 25         // Defense Fighting Style
#define AFF_HASTE 26           // Haste Spell
#define AFF_REGEN 27           // Regeneration Spell
#define AFF_QUICKCAST 28       // (R) Quickcast  // remove for skill
#define AFF_PARA 29            // (R) char is paralyzed
#define AFF_MIRROR_IMAGES 30   // (R) char has mirror images
#define AFF_RAGE 31            // Fighter Rage
#define AFF_IMPROVED_INVIS 32  // char has improved invisibility
#define AFF_HARMONY 33         // (R) bard harmony chant
#define AFF_DISSONANCE 34      // (R) bard dissonance chant
#define AFF_SLOW     35        // (R) slow
#define AFF_RITUAL 36         // (R) from ritual event
...
#define CON_REROLL 33       // Reroll stats at login
...
#define ITEM_TOKEN 7      /**< Quest tokens		*/
...
#define ITEM_BARD 14      /**< Unimplemented		*/
...
#define ITEM_WEAR_OFFHAND 14
#define ITEM_WEAR_HOLD 15     /**< Item can be held */
#define ITEM_WEAR_FLOATING 16 // Salty
...
#define ITEM_ANTI_KNIGHT 16  /* Not usable by knights*/
#define ITEM_ANTI_BARD 17    /* Not usable by bards*/
...
#define APPLY_LUCK 6           /**< Apply to charisma		*/
...
#define APPLY_HITP_REGEN 25    /* Apply to int hit_gain() in limits.c*/
#define APPLY_MANA_REGEN 26    /* Apply to int mana_gain() in limits.c */
#define APPLY_MOVE_REGEN 27    /* Apply to int move_gain() in limits.c */
#define APPLY_SPELLS_HEALING 28
#define APPLY_SPELLS_DAMAGE 29
#define APPLY_SPELLS_AFFECTS 30
#define APPLY_MIRROR_IMAGE 31
...
#define LVL_IMPL 105       /**< Level of Implementors */
#define LVL_GRGOD 104      /**< Level of Greater Gods */
#define LVL_GOD 103        /**< Level of Gods */
#define LVL_DEITY 102      // Salty 6/19/2019
#define LVL_IMMORT 101     /**< Level of Immortals */
#define LVL_MAX_MORTAL 100 // Max level of mortals
/** Minimum level to build and to run the saveall command */
#define LVL_BUILDER LVL_DEITY
...
#define MAX_TITLE_LENGTH 40              /**< Max PC title length */
...
#define MAX_AFFECT 50                    /**< Max number of player affections */
#define MAX_OBJ_AFFECT 8                 /**< Max object affects */
...
struct time_data
{
  ...
  time_t logout; // Time of last logout, Salty 10 FEB 2020
...
struct char_player_data
{
  ...
  byte multiclass;                 /* Salty Multiclass */
...
{
  sh_int str;     /**< Strength.  */
  sh_int str_add; /**< Strength multiplier if str = 18. Usually from 0 to 100 */
  sh_int intel;   /**< Intelligence */
  sh_int wis;     /**< Wisdom */
  sh_int dex;     /**< Dexterity */
  sh_int con;     /**< Constitution */
  sh_int luck;    /* Luck, Salty 11 FEB 2020 */
};
...
struct char_point_data
{
  ...
  int combat_power; /* Level based combat power */
...
struct player_special_data_saved
{
  ...
  long total_exp;                        // Total exp for ranks
  int rank;                              // Salty, 06 JAN 2019
  int stat_trains;                       // Number of trains for mainstat
  int stat_trained;                      // Number of trains used
  int hitp_regen;                        // Bonus to hitpoint regen
  int mana_regen;                        // Bonus to mana regen
  int move_regen;                        // Bonus to move regen
  int spells_healing;                    // Bonus to healing spells
  int spells_damage;                     // Bonus to damage spells
  int spells_affects;                    // Bonus to affect spells
};
...
struct mob_special_data
{
  ...
  byte attack_num;    /* The number of our xdy+z attacks we are making*/
  byte mob_mult;      /* medit.c mob multiplier */
};
...
struct wis_app_type
{
  ...
  sh_int mana_gain; /* How much bonus mana wisdom classes gain per level */
  sh_int meta_mana; // Added to Mana meta
};
...
struct int_app_type
{
  ...
  sh_int mana_gain; /* How much bonus mana intelligence classes gain per level */
  sh_int meta_mana; // Added to Mana meta and max trains per level
};
...
struct con_app_type
{
  ...
  sh_int meta_hp; //  Added to HP meta
};
...
struct game_data
{
  ...
  long max_exp_gain;       /**< Maximum experience gainable per kill.*/
...
struct room_numbers
{
  ...
  room_vnum recall_room;       // Salty 10 FEB 2020
};
