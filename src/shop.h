...
#define IS_GOD(ch)		(!IS_NPC(ch) && (GET_REAL_LEVEL(ch) >= LVL_GOD))
...
#define TRADE_NOPRIEST     (1 << 4)
#define TRADE_NOROGUE      (1 << 5)
#define TRADE_NOFIGHTER    (1 << 6)
#define TRADE_NOKNIGHT     (1 << 7)
...
#define NOTRADE_PRIEST(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPRIEST))
