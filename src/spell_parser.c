	     ...
	     struct obj_data *ovict, int spellnum, int level, int casttype)
{
  ...
  if (IS_SET(SINFO.routines, MAG_MANUAL))
    ...
    case SPELL_RELOCATION:	MANUAL_SPELL(spell_relocate); break;
    case SPELL_CANCELLATION:    MANUAL_SPELL(spell_cancellation); break;
    case SPELL_BARD_GATEWAY:		MANUAL_SPELL(spell_gateway); break;
    case SPELL_BLOOD_MANA: 	MANUAL_SPELL(spell_blood_mana); break;
    case SPELL_SATIATE: 	MANUAL_SPELL(spell_satiate); break;
    case SPELL_LOCATE_CHARACTER: 	MANUAL_SPELL(spell_locate_char); break;
    }
...
void mag_assign_spells(void)
{
  ...
  TRUE, MAG_AFFECTS, NULL );
    ...
    spello(SPELL_FLAMING, "flaming", 100, 50, 5, POS_FIGHTING, TAR_CHAR_ROOM | TAR_FIGHT_VICT,
  TRUE, MAG_AFFECTS, NULL );

    spello(SPELL_FREEZING, "freezing", 100, 50, 5, POS_FIGHTING, TAR_CHAR_ROOM | TAR_FIGHT_VICT,
  TRUE, MAG_AFFECTS, NULL );
