...
#define PFDEF_TOTAL_EXP		0
#define PFDEF_RANK		0
#define PFDEF_TRAINS		0
#define PFDEF_HITP_REGEN 0
#define PFDEF_MANA_REGEN 0
#define PFDEF_MOVE_REGEN 0
#define PFDEF_SPELLS_HEALING 0
#define PFDEF_SPELLS_DAMAGE 0
#define PFDEF_SPELLS_AFFECTS 0
#define PFDEF_MELEE_RESISTS 0
